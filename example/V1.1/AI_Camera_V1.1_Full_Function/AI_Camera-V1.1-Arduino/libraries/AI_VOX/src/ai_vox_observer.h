...
class Observer {
 public:
  // State, transcript, emotion and IoT-control events share this queue. Voice
  // replies can generate a short burst of more than ten events; dropping the
  // oldest entry made occasional volume commands disappear before the UI task
  // consumed them.
