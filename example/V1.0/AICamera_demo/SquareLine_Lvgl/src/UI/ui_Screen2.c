...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0x2BF408), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_label_set_text(ui_Label2, "elecrow");
