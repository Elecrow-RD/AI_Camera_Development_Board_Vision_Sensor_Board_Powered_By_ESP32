...
esp_err_t tool_registry_init(void)
{
    ...
    mimi_tool_t gw = {
        .name = "gpio_write",
        .description = "Set a GPIO pin HIGH or LOW. Use for general digital outputs like relays or external circuits.",
        .input_schema_json =
            "{\"type\":\"object\","
    ...
    register_tool(&led_ctrl);

    tool_screen_init();

    mimi_tool_t dp = {
        .name = "draw_points",
        .description = "Draw multiple dots/pixels in a single call on the 240x284 screen. "
        ...
        .input_schema_json = "{"
                                ...
                                "\"type\":\"object\","
                                "\"properties\":{"
                                "\"x\":{\"type\":\"integer\",\"minimum\":0,\"maximum\":240},"
    ...
    mimi_tool_t dt = {
        ...
        .description = "Render text at specific coordinates on the 240x284 screen. "
                        "The text will automatically wrap at the right screen boundary (240px). "
                        "Coordinates (0,0) is the top-left corner. Default color is white.",
        .input_schema_json =
            "{"
            "\"type\":\"object\","
            "\"properties\":{"
            "\"x\":{\"type\":\"integer\",\"description\":\"Start X (0-239)\"},"
            "\"y\":{\"type\":\"integer\",\"description\":\"Start Y (0-283)\"},"
    ...
    mimi_tool_t ds = {
        .name = "draw_shapes",
        .description = "Draw shapes on 240x284 LCD. "
    ...
    mimi_tool_t cs = {
        .name = "clear_screen",
        .description = "Wipe the 240x284 LCD clean and reset to black background. "
